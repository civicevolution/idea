...
node[:applications].each do |app_name,data|
  ...
  # Needs sym link
	# sudo ln -sf /data/app_2029/shared/config/keep.database.yml /data/app_2029/shared/config/database.yml
	
	file "/data/#{app_name}/shared/config/database.yml" do
    action :delete
  end
  
	link "/data/#{app_name}/shared/config/database.yml" do
