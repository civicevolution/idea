...
module G3
  class Application < Rails::Application
    ...
    config.active_record.observers = :tracking_observer, :tracking_destroy_observer
    ...
    # HOME
    config.assets.precompile += %w( application_ce_home.css application_ce_home_home.js application_ce_home_no_js.js application_civic_home.css application_civic_home.js jquery.show_char_limit-1.1.1.js)
    # MISC
    ...
    config.assets.precompile += %w( application_ce_live.css application_ce_live.js 	ce_live/app_ce_live_table.js )
  	...
  	config.assets.precompile += %w( ce_live/theme_final_edit.css ce_live/app_ce_live_vote.js ce_live/table_multi_input.css ce_live/theme_details.css )
